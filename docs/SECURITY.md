...
When deploying, use GitHub Actions secrets to save and use settings from `.env` files securely. GitHub secrets are the source of truth when it comes to storing sensitive values in a production environment.
