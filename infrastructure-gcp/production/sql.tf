data "google_secret_manager_secret_version" "prod-postgres_password" {
 secret   = "prod-postgres-details-password"
}
data "google_secret_manager_secret_version" "db-name" {
 secret   = "prod-postgres-details-db-name"
}
...
resource "google_sql_user" "users" {
  name     = "svc_app"
  instance = google_sql_database_instance.prod-db.name
  password = data.google_secret_manager_secret_version.prod-postgres_password.secret_data
}