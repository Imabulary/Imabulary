...
mixin _$Set {
  ...
  List<({QuizStatuses QuizStatus, String image_url})>? get flashcards =>
...
abstract class $SetCopyWith<$Res> {
  ...
  $Res call(
      ...
      DateTime createdAt,
      DateTime updatedAt,
      List<({QuizStatuses QuizStatus, String image_url})>? flashcards});
}
    ...
    return _then(_value.copyWith(
      ...
      flashcards: freezed == flashcards
          ...
          : flashcards // ignore: cast_nullable_to_non_nullable
              as List<({QuizStatuses QuizStatus, String image_url})>?,
    ) as $Val);
  }
}
...
class _$SetImpl with DiagnosticableTreeMixin implements _Set {
  const _$SetImpl(
      ...
      final List<({QuizStatuses QuizStatus, String image_url})>? flashcards})
  ...
  final List<({QuizStatuses QuizStatus, String image_url})>? _flashcards;
  @override
  List<({QuizStatuses QuizStatus, String image_url})>? get flashcards {
...
abstract class _Set implements Set {
  const factory _Set(
      ...
      final List<({QuizStatuses QuizStatus, String image_url})>?
