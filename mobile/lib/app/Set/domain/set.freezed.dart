...
mixin _$Set {
  ...
  List<({QuizStatus QuizStatus, String image_url})>? get flashcards =>
...
abstract class $SetCopyWith<$Res> {
  ...
  $Res call(
      ...
      DateTime createdAt,
      DateTime updatedAt,
      List<({QuizStatus QuizStatus, String image_url})>? flashcards});
}
    ...
    return _then(_value.copyWith(
      ...
      flashcards: freezed == flashcards
          ...
          : flashcards // ignore: cast_nullable_to_non_nullable
              as List<({QuizStatus QuizStatus, String image_url})>?,
    ) as $Val);
  }
}
...
class _$SetImpl with DiagnosticableTreeMixin implements _Set {
  const _$SetImpl(
      ...
      final List<({QuizStatus QuizStatus, String image_url})>? flashcards})
  ...
  final List<({QuizStatus QuizStatus, String image_url})>? _flashcards;
  @override
  List<({QuizStatus QuizStatus, String image_url})>? get flashcards {
...
abstract class _Set implements Set {
  const factory _Set(
      ...
      final List<({QuizStatus QuizStatus, String image_url})>?
