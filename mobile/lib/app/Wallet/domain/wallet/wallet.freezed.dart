...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String userId, String status, double balance});
}
...
class _$WalletImpl implements _Wallet {
  ...
  @override
  String toString() {
    return 'Wallet(id: $id, userId: $userId, status: $status, balance: $balance)';
  }
...
abstract class _Wallet implements Wallet {
  const factory _Wallet(
      ...
      required final double balance}) = _$WalletImpl;
