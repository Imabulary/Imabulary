...
async function main() {
  await prisma.$transaction([
    prisma.feedbackCategory.createMany({
      data: [
        {
    ...
    prisma.packages.createMany({
      data: [
        { externalId: 'small', name: 'Small Package', coinsAmount: 20 },
        { externalId: 'medium', name: 'Medium Package', coinsAmount: 50 },
        { externalId: 'large', name: 'Large Package', coinsAmount: 100 },
      ],
    }),
  ]);
}
